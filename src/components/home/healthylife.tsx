      ...
      <div className="flex  max-w-[1780px] justify-between items-stretch flex-wrap gap-y-9 sm:mt-12 mt-4">
        {data?.points &&
          data?.points.map((card: any) => (
            ...
            >
              <div className="flex justify-center animate-scale rounded-full items-center mx-auto sm:w-24 sm:h-24 bg-green1 w-16 h-16 sticky sm:-mt-20 group-hover:scale-x-[-1] duration-200 -mt-9 text-white text-3xl sm:!text-6xl">
              <SiHappycow />
